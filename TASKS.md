...
- [x] **TASK-108**: Capture adapter, Remotion rendering bridge and integrity gates (depends 107; TASK-081 for remote URLs).
  ...
  - Added real high-resolution viewport Playwright capture (`demoforge/capture/capture_shots.py`) and dynamic Remotion composition ingestion (`HybridWalkthrough`, `HybridScene`, `BrowserFrame`, `HybridIntro`, `HybridOutro`). Successfully verified end-to-end against live portfolio `https://mohamedamine-portfolio.vercel.app/` (35s, 1050 frames, 0 decode errors, SHA-256: 618e310d67933ddadc490ea05494464c6067e42188b5519b0e44902c92bf9594).
